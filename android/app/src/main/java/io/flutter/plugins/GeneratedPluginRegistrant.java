...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.patricktailor.snowplow_flutter_tracker.SnowplowFlutterTrackerPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin snowplow_flutter_tracker, com.patricktailor.snowplow_flutter_tracker.SnowplowFlutterTrackerPlugin", e);
    }
    try {
